...
if __name__ == '__main__':
    ...
    # rate_list = [[0.5, 0.5, 0.5], [0.2, 0.5, 0.8], [0.5, 0.8, 0.2]]
    rate_list = [[0.2, 0.5, 0.8], [0.2, 0.8, 0.5], [0.5, 0.2, 0.8], [0.5, 0.8, 0.2], [0.8, 0.2, 0.5], [0.8, 0.5, 0.2]]
    missing_rate = rate_list[opt.rate_indx]
